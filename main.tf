locals {
  ...
  defaults = {
    ...
    label_order         = ["namespace", "stage", "short_region", "name", "attributes"]
  ...
  input = {
    ...
    short_region = var.short_region == null ? var.context.short_region : var.short_region
  ...
  string_label_names = ["namespace", "tenant", "stage", "short_region", "name"]
  ...
  short_region = local.formatted_labels["short_region"]
