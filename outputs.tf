...
output "short_region" {
  value       = local.enabled ? local.short_region : ""
  description = "Normalized short_region"
}
...
output "delimiter" {
  ...
  description = "Delimiter between `namespace`, `tenant`, `short_region`, `stage`, `name` and `attributes`"
}
